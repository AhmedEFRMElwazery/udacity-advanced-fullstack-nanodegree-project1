...
describe('Testing CreateProcessedImage module: ', (): void => {
  it('call the "createAProcessedImage" method from the "CreateProcessedImage", and checks if the image was created, and should return true it exists', async (): Promise<void> => {
