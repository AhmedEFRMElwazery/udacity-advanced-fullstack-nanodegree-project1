# Udacity's Advanced Full-Stack Web Development Nanodegree - Project1 (API for Image Processing)
...
**Screenshot - the result of running `jasmine` script: PLEASE NOTE that the highlighted segments appearing in magenta, green and red are NOT error messages. They are colored notifications. This is further explain in BOTH the [Notifications](#Notifications) and the [Remarks](#Remarks) sections**
...
**Screenshot - the result of running `test` script": PLEASE NOTE that the highlighted segments appearing in magenta, green and red are NOT error messages. They are colored notifications. This is further explain in BOTH the [Notifications](#Notifications) and the [Remarks](#Remarks) sections**
...
![the image titled santamonica is staring with an s character hence it is the last image in the folder from an alphabetical point of view and it is the one displayed](./assets/docs/trying-to-recreate-all-processed-image.PNG "the image titled santamonica is staring with an s character hence it is the last image in the folder from an alphabetical point of view and it is the one displayed")
